...
<script>
import { getProComments, getProDetail } from '@/api/prodetail'
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      // console.log('hello')
      const { data } = await addCart(this.goodsId, this.addCount, this.detail.skuList[0].goods_sku_id) // todo goods_sku_id是什么东西
    ...
    async getDetail () {
      ...
      this.detail = detail
      this.images = detail.goods_images.map((obj) => {
